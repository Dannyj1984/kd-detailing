    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="prose prose-lg mx-auto">
          ...
          Welcome to KD Detailing, your premier car detailing service in Greater Manchester. Since 2024, we&apos;ve been dedicated to providing exceptional car care services that go beyond the ordinary wash. Our passion for perfection and attention to detail has quickly established us as a trusted name in the automotive detailing industry.
          </p>
